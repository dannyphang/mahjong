            ...
            for (let j = 0; j < handTileAmount; j++) {
                ...
                do {
                    if (newMahjongList[0].type !== "Flower") {
                        ...
                        room.playerList[i].mahjong.flowerTiles.point += calculateMahjongTilePoints(newMahjongList[0], room.playerList[i]);
                    }
...
export { createGame, playerJoinRoom, updateRoom, playerQuitRoom, discardMahjong };
