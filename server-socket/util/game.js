...
import * as API from "../config/envConfig.js";
...
function getAllMahjong() {
    return new Promise(async function (resolve, reject) {
        request.get(`${API.default.apiBaseUrl}/mahjong`, { json: { key: "value" } }, function (error, response, body) {
            resolve(body.data);
        });
    });
}
...
function testGame(room) {
    return new Promise(async function (resolve, reject) {
        ...
        const mahjongList = getAllMahjong();

        console.log(mahjongList.length);
...
export { createGame, playerJoinRoom, updateRoom, playerQuitRoom, discardMahjong, nextTurn, drawMahjong, updatePlayer, actions, chowAction, calculateMahjongSetPoints, testGame };
